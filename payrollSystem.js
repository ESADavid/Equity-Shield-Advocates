...
var PayrollSystem = /** @class */ (function () {
  ...
  PayrollSystem.prototype.loadEmployees = function () {
    try {
      if (fs.existsSync(EMPLOYEES_FILE)) {
        ...
        this.employees = new Map(
          employeesArray.map(function (emp) {
            return [emp.id, emp];
          })
        );
      }
  ...
  PayrollSystem.prototype.addEmployee = function (input) {
    try {
      // Validate input
      var validationErrors = (0, payrollValidation_js_1.validateEmployeeInput)(
        input
      );
      ...
      // Sanitize input
      var sanitizedInput = (0, payrollValidation_js_1.sanitizeEmployeeInput)(
        input
      );
    ...
    try {
      ...
      var updateInput = __assign(
        __assign(
          __assign(
            __assign(
              __assign(
                __assign(
                  __assign(
                    __assign(
                      {
                        id: employeeId,
                        name:
                          (_a = updates.name) !== null && _a !== void 0
                            ? _a
                            : existingEmployee.name,
                        taxRate:
                          (_b = updates.taxRate) !== null && _b !== void 0
                            ? _b
                            : existingEmployee.taxRate,
                        deductions:
                          (_c = updates.deductions) !== null && _c !== void 0
                            ? _c
                            : existingEmployee.deductions,
                        bonuses:
                          (_d = updates.bonuses) !== null && _d !== void 0
                            ? _d
                            : existingEmployee.bonuses,
                      },
                      updates.position !== undefined ||
                        existingEmployee.position !== undefined
                        ? {
                            position:
                              (_e = updates.position) !== null && _e !== void 0
                                ? _e
                    ...
                    updates.department !== undefined ||
                      ...
                      ? {
                          department:
                            (_f = updates.department) !== null && _f !== void 0
                              ? _f
                  ...
                  updates.hourlyRate !== undefined ||
                    ...
                    ? {
                        hourlyRate:
                          (_g = updates.hourlyRate) !== null && _g !== void 0
                            ? _g
                            : existingEmployee.hourlyRate,
                      }
                    : {}
                ),
                updates.hoursWorked !== undefined ||
                  ...
                  ? {
                      hoursWorked:
                        (_h = updates.hoursWorked) !== null && _h !== void 0
                          ? _h
                          : existingEmployee.hoursWorked,
                    }
                  : {}
              ),
              updates.overtimeHours !== undefined ||
                ...
                ? {
                    overtimeHours:
                      (_j = updates.overtimeHours) !== null && _j !== void 0
                        ? _j
                        : existingEmployee.overtimeHours,
                  }
                : {}
            ),
            updates.salary !== undefined ||
              ...
              ? {
                  salary:
                    (_k = updates.salary) !== null && _k !== void 0
                      ? _k
          ...
          updates.accountNumber !== undefined ||
            ...
            ? {
                accountNumber:
                  (_l = updates.accountNumber) !== null && _l !== void 0
                    ? _l
        ...
        updates.routingNumber !== undefined ||
          ...
          ? {
              routingNumber:
                (_m = updates.routingNumber) !== null && _m !== void 0
                  ? _m
                  : existingEmployee.routingNumber,
            }
          : {}
      );
      // Validate updates
      ...
      // Sanitize and update
      var sanitizedUpdates = (0, payrollValidation_js_1.sanitizeEmployeeInput)(
        updateInput
      );
      var updatedEmployee = __assign(
        __assign(__assign({}, existingEmployee), sanitizedUpdates),
        { id: employeeId }
      );
    ...
    try {
      ...
      for (var _i = 0, _b = this.employees.values(); _i < _b.length; _i++) {
        ...
        if ((0, payrollCalculator_js_1.isSalariedEmployee)(employee)) {
          calculation = (0, payrollCalculator_js_1.calculateSalariedPayroll)(
            employee,
            payPeriod
          );
        } else {
          calculation = (0, payrollCalculator_js_1.calculatePayrollForEmployee)(
            employee
          );
        }
        var record = __assign(__assign({}, calculation), {
  ...
  PayrollSystem.prototype.getPayrollSummary = function (payPeriod) {
    try {
      ...
      var employees = Array.from(this.employees.values()).filter(function (e) {
        return e.isActive;
      });
      var summary = (0, payrollCalculator_js_1.calculatePayrollSummary)(
        employees,
        targetPeriod
      );
      return {
