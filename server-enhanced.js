...
import { resolveModuleDir } from './utils/modulePath.js';
...
const __dirname = resolveModuleDir(undefined, process.cwd());
...
if (isTestEnv || process.env.SKIP_DATABASE === 'true') {
...
// Start server (do not auto-listen during test imports)
if (!isTestEnv) {
  server.listen(PORT, () => {
