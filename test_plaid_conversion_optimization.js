...
describe('Plaid Link Conversion Optimization Tests', () => {
  ...
  describe('PlaidAnalyticsService', () => {
    test('should track link token creation', () => {
      const trackingId = plaidAnalyticsService.trackLinkTokenCreation(
        'user123',
        ['transactions']
      );
    ...
    test('should track public token exchange', () => {
      ...
      plaidAnalyticsService.trackPublicTokenExchange(
        trackingId,
        'public-token-123'
      );
    ...
    test('should track successful connection', () => {
      ...
      plaidAnalyticsService.trackSuccessfulConnection(
        trackingId,
        'access-token-123',
        'item-123',
        []
    ...
    test('should track failed connection', () => {
      ...
      plaidAnalyticsService.trackFailedConnection(
        trackingId,
    ...
    test('should track retry attempts', () => {
      ...
      plaidAnalyticsService.trackRetryAttempt(
        trackingId,
        1,
        'exponential_backoff'
      );
    ...
    test('should track fallback success', () => {
      ...
      plaidAnalyticsService.trackFallbackSuccess(
        trackingId,
        'ins_bad',
        'ins_good'
      );
    ...
    test('should calculate conversion funnel correctly', () => {
      ...
      const trackingId1 = plaidAnalyticsService.trackLinkTokenCreation(
        'user1',
        ['transactions']
      );
      const trackingId2 = plaidAnalyticsService.trackLinkTokenCreation(
        'user2',
        ['transactions']
      );
      const trackingId3 = plaidAnalyticsService.trackLinkTokenCreation(
        'user3',
        ['transactions']
      );
      ...
      expect(funnel.conversion_rates.overall_conversion_rate).toBeCloseTo(
        33.33,
        1
      );
    });
  ...
  describe('InstitutionHealthService', () => {
    test('should record institution interactions', () => {
      institutionHealthService.recordInstitutionInteraction(
        'ins_1',
        true,
        1500
      );
    ...
    test('should get top performing institutions', () => {
      ...
      const topPerformers =
        institutionHealthService.getTopPerformingInstitutions(2);
    ...
    test('should provide institution recommendations', () => {
      ...
      const recommendations =
        institutionHealthService.getInstitutionRecommendations();
    ...
    test('should get fallback institutions', () => {
      ...
      const fallbacks =
        institutionHealthService.getFallbackInstitutions('ins_3');
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    test('should handle unknown institution health queries', () => {
      const health =
        institutionHealthService.getInstitutionHealth('ins_unknown');
