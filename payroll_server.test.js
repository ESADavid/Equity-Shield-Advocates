...
const payroll_server_1 = __importDefault(require("./payroll_server"));
describe('Payroll Server API', () => {
    ...
    beforeAll(async () => {
        ...
        if (payroll_server_1.default && payroll_server_1.default.close) {
            await new Promise((resolve) => payroll_server_1.default.close(resolve));
        }
    });
    it('should add a new employee', async () => {
        const res = await (0, supertest_1.default)(payroll_server_1.default)
    ...
    it('should get all employees', async () => {
        ...
        await (0, supertest_1.default)(payroll_server_1.default)
            .post('/api/payroll/employees')
            .send(testEmployee);
        const res = await (0, supertest_1.default)(payroll_server_1.default).get('/api/payroll/employees');
        expect(res.statusCode).toEqual(200);
    ...
    it('should delete an employee', async () => {
        ...
        await (0, supertest_1.default)(payroll_server_1.default)
            ...
            .send(testEmployee);
        // Now delete it
        const res = await (0, supertest_1.default)(payroll_server_1.default).delete(`/api/payroll/employees/${employeeId}`);
        expect(res.statusCode).toEqual(200);
    ...
    it('should process payroll', async () => {
        ...
        await (0, supertest_1.default)(payroll_server_1.default)
            .post('/api/payroll/employees')
            .send(testEmployee);
        const res = await (0, supertest_1.default)(payroll_server_1.default).post('/api/payroll/process');
        expect(res.statusCode).toEqual(200);
        expect(Array.isArray(res.body)).toBe(true);
    ...
    it('should handle hourly employee payroll calculation', async () => {
        ...
        const res = await (0, supertest_1.default)(payroll_server_1.default).post('/api/payroll/process');
        expect(res.statusCode).toEqual(200);
        const payrollRecord = res.body.find((p) => p.employeeId === hourlyEmployeeId);
        expect(payrollRecord).toBeDefined();
    ...
    it('should return welcome message with request logging', async () => {
        const res = await (0, supertest_1.default)(payroll_server_1.default).get('/api/payroll/welcome');
        expect(res.statusCode).toEqual(200);
...
//# sourceMappingURL=payroll_server.test.js.map