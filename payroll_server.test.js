...
describe('Payroll Server API', () => {
  ...
  it('should get all employees', async () => {
    ...
    await (0, supertest_1.default)(payroll_server_1.default)
      .post('/api/payroll/employees')
      .send(testEmployee);
    const res = await (0, supertest_1.default)(payroll_server_1.default).get(
  ...
  it('should delete an employee', async () => {
    ...
    await (0, supertest_1.default)(payroll_server_1.default)
      ...
      .send(testEmployee);
    // Now delete it
    const res = await (0, supertest_1.default)(payroll_server_1.default).delete(
  ...
  it('should process payroll', async () => {
    ...
    await (0, supertest_1.default)(payroll_server_1.default)
      .post('/api/payroll/employees')
      .send(testEmployee);
    const res = await (0, supertest_1.default)(payroll_server_1.default).post(
      '/api/payroll/process'
    );
    expect(res.statusCode).toEqual(200);
    expect(Array.isArray(res.body)).toBe(true);
  ...
  it('should handle hourly employee payroll calculation', async () => {
    ...
    const payrollRecord = res.body.find(
      (p) => p.employeeId === hourlyEmployeeId
    );
    expect(payrollRecord).toBeDefined();
