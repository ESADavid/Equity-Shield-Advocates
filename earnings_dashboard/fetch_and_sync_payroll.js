...
async function loadPayrollIntegrations() {
  try {
    const payrollModule = await Promise.resolve().then(() =>
      __importStar(require('../payroll_integration.js'))
    );
  ...
  try {
    const qbModule = await Promise.resolve().then(() =>
      __importStar(require('../quickbooks_payroll_integration.js'))
    );
