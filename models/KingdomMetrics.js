...
KingdomMetricsSchema.methods.calculateITGScore = function() {
  ...
  // Growth Score (0-100)
  const growthRate = (
    (this.kingdomExpansion.influence.growth / this.kingdomExpansion.influence.current * 100 * 0.25) +
    (this.kingdomExpansion.resources.growth / this.kingdomExpansion.resources.current * 100 * 0.25) +
    (this.kingdomExpansion.territory.growth / this.kingdomExpansion.territory.current * 100 * 0.25) +
    (this.kingdomExpansion.people.growth / this.kingdomExpansion.people.current * 100 * 0.25)
  );
...
KingdomMetricsSchema.methods.expandKingdom = function(expansion) {
  if (expansion.influence) {
    this.kingdomExpansion.influence.growth = expansion.influence - this.kingdomExpansion.influence.current;
    this.kingdomExpansion.influence.current = expansion.influence;
  }
  if (expansion.resources) {
    this.kingdomExpansion.resources.growth = expansion.resources - this.kingdomExpansion.resources.current;
    this.kingdomExpansion.resources.current = expansion.resources;
  }
  if (expansion.territory) {
    this.kingdomExpansion.territory.growth = expansion.territory - this.kingdomExpansion.territory.current;
    this.kingdomExpansion.territory.current = expansion.territory;
  }
  if (expansion.people) {
    this.kingdomExpansion.people.growth = expansion.people - this.kingdomExpansion.people.current;
