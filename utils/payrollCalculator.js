...
function calculatePayrollForEmployee(employee, overrides) {
    ...
    var hoursWorked = (_b = (_a = overrides === null || overrides === void 0 ? void 0 : overrides.hoursWorked) !== null && _a !== void 0 ? _a : employee.hoursWorked) !== null && _b !== void 0 ? _b : 0;
    var hourlyRate = (_d = (_c = overrides === null || overrides === void 0 ? void 0 : overrides.hourlyRate) !== null && _c !== void 0 ? _c : employee.hourlyRate) !== null && _d !== void 0 ? _d : 0;
    var overtimeHours = (_f = (_e = overrides === null || overrides === void 0 ? void 0 : overrides.overtimeHours) !== null && _e !== void 0 ? _e : employee.overtimeHours) !== null && _f !== void 0 ? _f : 0;
    var taxRate = (_g = overrides === null || overrides === void 0 ? void 0 : overrides.taxRate) !== null && _g !== void 0 ? _g : employee.taxRate;
    var deductions = (_h = overrides === null || overrides === void 0 ? void 0 : overrides.deductions) !== null && _h !== void 0 ? _h : employee.deductions;
    var bonuses = (_j = overrides === null || overrides === void 0 ? void 0 : overrides.bonuses) !== null && _j !== void 0 ? _j : employee.bonuses;
    var payPeriod = (_k = overrides === null || overrides === void 0 ? void 0 : overrides.payPeriod) !== null && _k !== void 0 ? _k : new Date().toISOString().split('T')[0];
    // Calculate regular pay
    var regularPay = hoursWorked * hourlyRate;
    // Calculate overtime pay (1.5x regular rate)
    var overtimePay = overtimeHours * hourlyRate * payroll_js_1.PAYROLL_CONSTANTS.OVERTIME_MULTIPLIER;
    // Calculate gross pay
...
function calculateSalariedPayroll(employee, payPeriod) {
    if (payPeriod === void 0) { payPeriod = new Date().toISOString().split('T')[0]; }
    if (!employee.salary) {
...
function calculatePayrollSummary(employees, payPeriod) {
    ...
    var summary = calculations.reduce(function (acc, calc) { return ({
    ...
    return __assign(__assign({}, summary), { payPeriod: payPeriod, generatedAt: new Date().toISOString(), calculations: calculations });
}
/**
 * Validates that calculated payroll makes mathematical sense
 */
function validatePayrollCalculation(calculation) {
    var expectedGrossPay = calculation.regularPay + calculation.overtimePay + calculation.bonuses;
    var expectedNetPay = calculation.grossPay - calculation.taxAmount - calculation.deductions;
